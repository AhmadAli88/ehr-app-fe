import { FiGrid, FiSearch, FiHome, FiActivity, FiCalendar, FiMapPin, FiFileText, FiMessageCircle, FiZap, FiSettings, FiLogOut, FiUsers, FiPackage, FiList } from "react-icons/fi";
